...
// TODO: Remove VITE_* fallback after final TanStack/Vite cleanup.
...
export function isProtectedDeliveryEnabled() {
  return readPublicEnv(
    "NEXT_PUBLIC_ENABLE_PROTECTED_DELIVERY",
    "VITE_ENABLE_PROTECTED_DELIVERY",
  ) === "true";
}
...
export function getRazorpayKeyId() {
  return readPublicEnv("NEXT_PUBLIC_RAZORPAY_KEY_ID", "VITE_RAZORPAY_KEY_ID");
}
