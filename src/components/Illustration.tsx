...
export function Illustration({ variant = "books", className, size = 220 }: Props) {
    ...
    return (
      <svg {...common}>
        ...
        <rect
          ...
          height="100"
          rx="8"
          className="fill-accent/40 stroke-primary"
          strokeWidth="3"
        />
  ...
  if (variant === "leaf") {
    return (
      <svg {...common}>
        <path
          d="M60 200 C 90 120, 180 60, 280 60 C 270 160, 200 210, 90 210 Z"
          className="fill-accent/50 stroke-primary"
          strokeWidth="3"
        />
        <path
          d="M90 210 C 140 170, 200 130, 270 80"
          className="stroke-primary"
          strokeWidth="3"
          fill="none"
          strokeLinecap="round"
