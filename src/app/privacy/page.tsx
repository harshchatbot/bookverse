        ...
        <section className="mx-auto max-w-3xl px-4 pb-20 sm:px-6 lg:px-8">
          ...
          <div className="space-y-10">
            ...
            <Section title="Third-Party Services">
              ...
              <p>These services are provided by Google and are subject to their respective privacy policies and data processing terms.</p>
            </Section>
            <Section title="Data Sharing">
              <p>We do not sell your personal data. Your contact information is shared only as you choose — for example, when you list a book, your displayed name and city are visible to other users. If you include a WhatsApp number in a listing, that is visible to potential buyers.</p>
              <p>We may disclose information if required by law, to enforce our terms, or to protect the rights and safety of our users.</p>
            </Section>
            ...
            <Section title="Data Security">
              <p>We use industry-standard practices to protect your data, including secure authentication via Firebase, encrypted data transmission, and access controls on our database. However, no internet-based service can guarantee 100% security. Please use strong passwords and avoid sharing sensitive information in public listings.</p>
            </Section>
            <Section title="Data Retention">
              <p>We retain your account and listing data for as long as your account is active. If you delete your account, we will remove your personal data from active systems within a reasonable timeframe, though some data may remain in backups or logs for legal or technical reasons.</p>
            </Section>
            <Section title="Children's Privacy">
              <p>BookVerse is not intended for children under 16. We do not knowingly collect personal information from children. If you believe we have inadvertently collected data from a child, please contact us and we will delete it promptly.</p>
            </Section>
            <Section title="Changes to This Policy">
              <p>We may update this Privacy Policy from time to time. Significant changes will be communicated via email or a notice on the platform. Continued use of BookVerse after changes constitutes acceptance of the updated policy.</p>
            </Section>
            <Section title="Contact">
              <p>For privacy-related questions, data deletion requests, or concerns about how your information is handled, please reach out through the platform or contact The Technology Fiction directly.</p>
            </Section>
          </div>
        </section>
      </main>
