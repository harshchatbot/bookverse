      ...
      <main className="flex-1">
        <section className="relative overflow-hidden">
          ...
          <div className="mx-auto max-w-3xl px-4 py-16 text-center sm:px-6 lg:px-8">
            ...
            <p className="mt-3 text-sm text-muted-foreground">How returns and refunds work on BookVerse</p>
          </div>
        </section>
        <section className="mx-auto max-w-3xl px-4 pb-20 sm:px-6 lg:px-8">
          ...
          <div className="space-y-10">
            <Section title="No Platform-Managed Payments">
              <p>BookVerse does not currently process payments, hold funds, or facilitate checkout on the platform. All transactions are conducted directly between the buyer and the seller — typically via UPI, bank transfer, cash on delivery, or any other mutually agreed payment method.</p>
              <p>Because of this, BookVerse cannot issue refunds, process chargebacks, or reverse payments. Any refund or return must be arranged directly between the buyer and seller.</p>
            </Section>
            ...
            <Section title="Dispute Resolution">
              <p>If a transaction goes wrong — for example, the book received does not match the description, or a seller fails to deliver — BookVerse may assist by reviewing the report, contacting the involved parties, or removing problematic listings. However, BookVerse is not liable for monetary losses arising from direct transactions between users.</p>
              <p>We strongly encourage buyers and sellers to communicate clearly, document agreements in writing (e.g., WhatsApp chat), and use trusted payment methods.</p>
            </Section>
            <Section title="When to Report a Problem">
              ...
              <p>Reports help us keep BookVerse safe, but they do not automatically result in financial compensation.</p>
            </Section>
            <Section title="Future Platform-Managed Transactions">
              <p>If BookVerse introduces platform-managed payments, escrow, or shipping integrations in the future, a separate refund and return policy will apply to those transactions. This page will be updated at that time, and users will be notified in advance.</p>
            </Section>
            <Section title="Contact">
              <p>For questions about refunds, returns, or a specific transaction issue, please reach out through the platform or contact The Technology Fiction directly.</p>
            </Section>
          </div>
        </section>
      </main>
